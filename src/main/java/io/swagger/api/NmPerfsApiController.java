...
@Controller
public class NmPerfsApiController implements NmPerfsApi {

    public ResponseEntity<Per> nmPerfsGet(@ApiParam(value = "The nfvi username", required = true) @RequestParam(value = "username", required = true) String username
